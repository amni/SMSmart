...
**Examples:** 
```
Text - 'z(1/1) @Yelp search:  longlat: true near: 40.74503998,-73.99879607 category: Pizza key: z limit: 1'
Response - '0z^1|NY Pizza Suprema (Pizza)|413 8th Ave, New York, NY 10001|(212) 594-8939|4.0 stars|open'
```
```
Text - 'z(1/1) @Yelp: near: Durham, NC category: bars key: z'
...
**Examples:**
```
Text - 'z(1/1) @Maps directions: from: san jose, CA to: san francisco, CA key: z'
...
```
```
Text - 'z(1/1) @Maps directions: from: chapel hill, NC to: Durham, NC key: z mode: walking'
...
**Examples:**
```
Text - 'z(1/1) @ Wikipedia search: term: Ford limit: 3 key: z'
...
```
```
Text - 'z(1/1) @ Wikipedia summary: search: cars limit: 5 key: z'
