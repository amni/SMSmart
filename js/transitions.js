...
(function callTransitions() {
    var interval = 5000,
        ...
        text_message_arr = [{user_text: "maps: directions from E Evelyn Ave to Castro Street", response_text: '1. Head west on E Evelyn Ave toward Ferry Morse Way after 0.6 miles <br> 2. Turn left onto Calderon Ave after 0.5 miles'}, {user_text: "yelp: find coffee shops on castro street", response_text: 'Red Rock Coffee <br> 3.5 Stars <br> 201 Castro Street'}, {user_text: "venmo: pay Ben 60.00 for taxi to Golden Gate Bridge", response_text: 'You just paid Ben 60.00 for a taxi to Golden Gate Bridge'}];
